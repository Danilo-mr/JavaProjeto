...
public class Janela extends Labirinto implements Serializable, Cloneable {
	...
	JFrame janela3 = new JFrame("Selecionar Labirintos");
	...
	JTextField textField8 = new JTextField("Informe seu email para selecionar todos Labirintos", 20);
	JTextField textField9 = new JTextField("Informe sua senha para selecionar todos Labirintos", 20);
