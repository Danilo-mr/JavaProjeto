...
public class Teclado {
    ...
    /**
     este método pega o input de um byte dado pela pessoa
     ele converte o input do byte que sempre vem em string pro tipo byte
   ...
   /**
     este método pega o input de um short dado pela pessoa
     ele converte o input do short que sempre vem em string pro tipo short
    ...
    */
    ...
    /**
     este método pega o input de um int dado pela pessoa
     ele converte o input do int que sempre vem em string pro tipo int
    ...
    */
    ...
    public static int getUmInt() throws Exception {
     ...
     /**
     este método pega o input de um long dado pela pessoa
     ele converte o input do long que sempre vem em string pro tipo long
    ...
    */
    ...
    public static long getUmLong() throws Exception {
     ...
     /**
     este método pega o input de um float dado pela pessoa
     ele converte o input do float que sempre vem em string pro tipo float
    ...
    */
    ...
    public static float getUmFloat() throws Exception {
     ...
     /**
     este método pega o input de um double dado pela pessoa
     ele converte o input do double que sempre vem em string pro tipo double
    ...
    */
    ...
    public static double getUmDouble() throws Exception {
     ...
     /**
     este método pega o input de um boolean dado pela pessoa
     ele converte o input do boolean que sempre vem em string pro tipo double
    ...
    */
    ...
    public static boolean getUmBoolean() throws Exception {
     ...
     /**
     este método pega o input de um char dado pela pessoa
     ele converte o input do char que sempre vem em string pro tipo char
