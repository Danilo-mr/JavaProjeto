...
public class SupervisoraDeConexao extends Thread
{
    ...
    public void run ()
    {
        ...
        try
        {
            ...
            for(;;)
            {
            	System.out.println("Entrow");
            	
                Comunicado comunicado = (Comunicado)this.usuario.envie();
                
                System.out.println("Entrow2");
                if (comunicado==null)
                    return;
                ...
                if(comunicado instanceof Lab) {
                	System.out.println("Oi haha");
                }
